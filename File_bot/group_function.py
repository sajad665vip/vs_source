    ...
    if m.text == "المطورين":
        if sudo2(m):
            try:
                ...
                if lang is None:
                    await m.reply_text(f"◍ [𝑺𝑯𝑨𝑫𝑶𝑾](tg://user?id={super_sudoers[0]})\n" +
                                       f"◍ [𝑺𝑬𝒁𝑹](tg://user?id={super_sudoers[1]})\n" +
                                       f"◍ [{n.first_name}](tg://user?id={sudoers[0]})\n\n"
                                       "لا يوجد مطورين مرفوعين\n√", reply_to_message_id=m.message_id,
                                       parse_mode="Markdown")
                else:
                    t = "\n◍ قائمة المطورين \n≪━━━━━━━━━━━━━≫\n" + f"◍ [𝐎𝐒𝐀𝐌𝐀](tg://user?id={super_sudoers[0]})\n" + f"◍ [𝗩𝗘𝗡𝗢𝗠](tg://user?id={super_sudoers[1]})\n" + \
                        f"◍ [{n.first_name}](tg://user?id={sudoers[0]})\n\n√"
                    for row in lang:
                        t = t + f"[{row[1]}](tg://user?id={row[0]})\n"
                    await m.reply_text(t, reply_to_message_id=m.message_id, parse_mode="Markdown")
    ...
    if m.text == "المطورين الثانويين":
        if sudo2(m):
            try:
                ...
                n = await c.get_users(sudoers[0])
                if lang is None:
                    await m.reply_text(f"◍ [𝐎𝐒𝐀𝐌𝐀](tg://user?id={super_sudoers[0]})\n" +
                                       f"◍ [𝗩𝗘𝗡𝗢𝗠](tg://user?id={super_sudoers[1]})\n" +
                                       f"◍ [{n.first_name}](tg://user?id={sudoers[0]})\n"
...
########################################################################################################################
    ...
    if m.text == "السورس" or m.text == "سورس" or m.text == "يا سورس":
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            ...
            [ InlineKeyboardButton ( "CH SOURCE", url=f"https://t.me/MRv7x" )], 
